...
//console.log("actions",actions,animations)
  ...
  useEffect(() => {
    ...
    const handleKeyUp = (event) => {
      ...
      setCurrentAnimation("CharacterArmature|Idle"); // Reset animation to idle on keyup
    };
  ...
  useFrame(() => {
    ...
    const forward = new THREE.Vector3(0, 0, -0.04); // Movement step size
   ...
   /*  if (keysPressed.current.has("s")) {
      ...
      //newRotation[1] = -Math.PI
      setCurrentAnimation("CharacterArmature|Run_Back"); 
    } */
